...
```yaml
dependencies:
  didit_sdk_core: ^4.7.2 # or didit_sdk_autodetection / didit_sdk_nfc
```
...
didit_sdk_ios_podspec = 'https://raw.githubusercontent.com/didit-protocol/sdk-ios/4.7.2/DiditSDK.podspec'
