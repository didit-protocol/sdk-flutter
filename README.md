...
```yaml
dependencies:
  didit_sdk_core: ^4.5.1 # or didit_sdk_autodetection / didit_sdk_nfc
```
...
didit_sdk_ios_podspec = 'https://raw.githubusercontent.com/didit-protocol/sdk-ios/4.5.1/DiditSDK.podspec'
