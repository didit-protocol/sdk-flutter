...
variant (automatic capture without NFC). Generated from didit_sdk.
                       DESC
  s.homepage         = 'https://github.com/didit-protocol/sdk-flutter'
  s.license          = { :file => '../LICENSE' }
  s.author           = { 'Didit' => 'support@didit.me' }
  s.source           = { :path => '.' }
  s.source_files = 'didit_sdk_autodetection/Sources/didit_sdk_autodetection/**/*.swift'
  s.resource_bundles = { 'didit_sdk_autodetection_privacy' => ['didit_sdk_autodetection/Sources/didit_sdk_autodetection/Resources/PrivacyInfo.xcprivacy'] }
  ...
  s.dependency 'DiditSDK/AutoDetection', '4.7.2'
